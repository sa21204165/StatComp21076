...
RcppExport SEXP _StatComp21076_gibbsC(SEXP NSEXP, SEXP thinSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _StatComp21076_vaccC(SEXP ageSEXP, SEXP femaleSEXP, SEXP ilySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_StatComp21076_gibbsC", (DL_FUNC) &_StatComp21076_gibbsC, 2},
    {"_StatComp21076_vaccC", (DL_FUNC) &_StatComp21076_vaccC, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_StatComp21076(DllInfo *dll) {
